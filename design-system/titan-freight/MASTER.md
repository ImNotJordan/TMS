...
> **PROJECT OVERRIDE (Titan Freight):** The live app uses **shadcn/ui New York** + Tailwind v4
> with **oklch CSS variables** in `src/styles.css`. Prefer those tokens over the hex table below
> unless explicitly redesigning the theme. Keep Lucide icons, dense ops layouts, and avoid
> purple/AI-gradient chrome. Anthropic frontend-design applies for distinctive landing/marketing;
> the authenticated shell stays operational and readable.

---

**Project:** Titan Freight
**Generated:** 2026-08-01 15:53:01
**Category:** B2B Service
**Stack:** shadcn/ui (New York) + React + Tailwind v4 + Lucide
